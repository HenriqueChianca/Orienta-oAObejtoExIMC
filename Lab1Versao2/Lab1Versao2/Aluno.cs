...
namespace Lab1Versao2
{
    class Aluno
    {
        ...
        public String DescreverSituacaoCorporal()
        {
            ...
            {
                situacaocorporal = "está em seu peso normal";
            }
            if ((25.0 <= imc) && (29.9 >= imc))
            {
                situacaocorporal = "está acima do seu peso(sobrepeso)";
            }
            if ((30.0 <= imc) && (34.9 >= imc))
            {
                situacaocorporal = "está com obesidade grau 1";
            }
            if ((35.0 <= imc) && (40.0 >= imc))
            {
                situacaocorporal = "está com obesidade grau 2";
            }
            if (40.0 > imc)
            {
                situacaocorporal = "está com obesidade grau 3 e 4";
            }
